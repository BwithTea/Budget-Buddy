...
# On startup you are welcomed by a list of bills and then a menu
# you can add to the list, make calculations of list
...
# #--------------------------------------------------------------#
# # Budget creator
# def create_budget(): #list of bills should be here as parameter
#   #Generator Is Active
#   list_of_bills = []
...
# #Test New Features
# bills = [
#   {"name":"gas","date":"10-20-2010","amount":30},
#   {"name":"food","date":"10-20-2010","amount":30},
#   {"name":"electricity","date":"10-20-2010","amount":30}
# ]
# newfile = open("Textfile.txt",'w')

# for bill in bills :
#   newfile.write(f"{bill['name']},{bill['date']},{bill['amount']}\n")
...
# print(bills)
# #Strip removes any whitespace, this includes the line break!
# for line in newfile:
#   data = line.strip("\n").split(",")
#   bills.append({"name":data[0],"date":data[1],"amount":data[2]})
