import time
# What I learned
# Improved skills in iterating over dictionaries and lists
# Using user inputs to create lists and dictionaries
# Using helper functions to make the code more clean and readable
